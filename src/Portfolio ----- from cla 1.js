        ...
        <div className="relative w-12 h-12 bg-white rounded border border-slate-200 flex-shrink-0">
          ...
          <div
            ...
            style={{
              ...
              left: '50%',
              top: '32%',
              transform: 	ranslateX(-50%) rotate(deg),
    ...
    <div className="max-w-4xl mx-auto px-4">
      <div className="bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-semibent text-slate-900 mt-8 mb-4">Philosophy</h2>
          <p className="text-slate-700 mb-4">
            ...
            is not just beneficialit's essential for driving meaningful innovation and improvement.
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="space-y-6">
          <p className="text-lg text-slate-700 leading-relaxed">
            ...
            world of technology, staying current is not just an advantageit's a necessity.
          </p>
